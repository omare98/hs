...
2. common.js
    * 파일관련 기능함수 추가
        * getFileList() : 파일목록정보 조회 후 화면생성
            ...
            * fileNum : 한라인에 보여줄 파일갯수 (default : 1, max : 4)
...
3. /templates/components/common-file.html
    * 공통 첨부파일 컴포넌트
        * 공통적인 첨부파일 UI를 생성한다.
...
4. /templates/components/psmstr-input.html
    * 사원검색 컴포넌트
...
5. /templates/components/org-input.html
    * 조직검색 컴포넌트
        * callback 옵션 추가
