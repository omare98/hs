...
2. common.js
    * 파일관련 기능함수 추가
        * getFileList() : 파일목록정보 조회 후 화면생성
            * atchFileId : 첨부파일ID
            * fileListElId : 파일목록 element id (default : atchFileTrunk)
...
3. /templates/components/common-file-div.html
    * 공통 첨부파일 Div 컴포넌트
        ...
        * arguments
            ...
            * fileListId : 첨부파일ID (atchFileId)의 파일정보를 표현하는 테이블의 ID (default : 'file-fileList')
        
        ```html
        <!-- id는 fileDrop 의 id를 명시한다. -->
        <div th:replace="components/common-file-div :: common-file-div(id='fileDrop1', fileListId='fileList1'"></div>
        ```
...
4. /templates/components/common-file.html
    * 공통 첨부파일 컴포넌트
        ...
        * arguments
        ...
        ```html
        <!-- id는 fileDrop 의 id를 명시한다. -->
        <table th:replace="components/common-file :: common-file(id='fileDrop')"></table>
        ```
